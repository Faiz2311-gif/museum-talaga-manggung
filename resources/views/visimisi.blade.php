...
<body class="bg-amber-50 text-stone-900 antialiased font-sans min-h-screen flex flex-col">
    ...
    <a href="{{ url('sejarah') }}" class="block px-4 py-2.5 text-xs border-b border-amber-100 {{ request()->is('sejarah') ? 'bg-amber-100 text-amber-900 font-semibold' : 'text-stone-700 hover:bg-amber-50 hover:text-amber-800' }}">Sejarah</a>

    <!-- Pindahkan logika class highlight ke bawah sini -->
    <a href="{{ url('visimisi') }}" class="block px-4 py-2.5 text-xs border-b border-amber-100 {{ request()->is('visimisi') || Request::anchor() == 'visimisi' ? 'bg-amber-100 text-amber-900 font-semibold' : 'text-stone-700 hover:bg-amber-50 hover:text-amber-800' }}">Visi & Misi</a>

    <a href="{{ url('strukturorg') }}" class="block px-4 py-2.5 text-xs text-stone-700 hover:bg-amber-50 hover:text-amber-800">Struktur Organisasi</a>
</div>
                </div>
